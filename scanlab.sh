...
PDSH_SSH_ARGS_APPEND="-q -tt " /net/loki/share/bin/pdsh -t 2 -w zahn[1-6],tuki[1-6],aeryn[2-5],ibm[01-02] /net/loki/share/bin/bdname.sh 2>/dev/null | /net/loki/share/bin/dshbak -c
#done;
